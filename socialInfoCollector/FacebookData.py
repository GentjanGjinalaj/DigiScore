...
def facebookDataCompetitor(facebook_link,facebook_username,competitor_num):
    st=time.time()
    #return 0
    print('Started executing FacebookDataCompetitor.py')
    ...
    et=time.time()
    facebook_time=et-st
    print('Total execution time of FacebookDataCompetitor.py is:',facebook_time,'seconds')

    return facebook_time


#facebookDataCompetitor('cvsdv','qewfw',1)