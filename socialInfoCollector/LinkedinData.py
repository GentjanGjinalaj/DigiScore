...
def linkedinDataCompetitor(linkedin_link,linkedin_username,competitor_num):
    st=time.time()
    #return 0
    print('Started executing LinkedinkDataCompetitor.py')
...
#linkedinDataCompetitor('qwerty','test',1)