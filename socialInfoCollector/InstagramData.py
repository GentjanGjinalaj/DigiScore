...
def instagramDataCompetitor(instagram_username,competitor_num):
    st=time.time()
    #return 0
    ...
    et=time.time()
    instagram_time=et-st
    print('Total execution time of InstagramDataCompetitor.py is:',instagram_time,'seconds')

    return instagram_time

#instagramDataCompetitor('icdparis',1)